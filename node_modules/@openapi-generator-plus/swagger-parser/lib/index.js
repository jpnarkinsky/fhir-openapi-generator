...
SwaggerParser.prototype.resolve = async function (path, api, options, callback) {
  options.crawl = crawl.resolveCrawl;

  let $refs = await $RefParser.prototype.resolve.call(this, path, api, options, callback);
  return $refs;
};
